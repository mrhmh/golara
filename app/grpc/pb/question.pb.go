...
func (x *PaginateRequest) GetPage() string {
	if x != nil {
		return x.Page
	}
	return ""
...
func (x *PaginateRequest) GetPerPage() string {
	if x != nil {
		return x.PerPage
	}
	return ""
...
func (x *IndexResponse) GetCode() int32 {
	if x != nil {
		return x.Code
	}
	return 0
...
var file_question_proto_rawDesc = []byte{
	...
	0x22, 0x40, 0x0a, 0x0f, 0x50, 0x61, 0x67, 0x69, 0x6e, 0x61, 0x74, 0x65, 0x52, 0x65, 0x71, 0x75,
	...
	0x67, 0x65, 0x22, 0x3d, 0x0a, 0x0d, 0x49, 0x6e, 0x64, 0x65, 0x78, 0x52, 0x65, 0x73, 0x70, 0x6f,
	...
	0x65, 0x32, 0x37, 0x0a, 0x08, 0x51, 0x75, 0x65, 0x73, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x2b, 0x0a,
	0x05, 0x49, 0x6e, 0x64, 0x65, 0x78, 0x12, 0x10, 0x2e, 0x50, 0x61, 0x67, 0x69, 0x6e, 0x61, 0x74,
	0x65, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x0e, 0x2e, 0x49, 0x6e, 0x64, 0x65, 0x78,
	0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x42, 0x07, 0x5a, 0x05, 0x70, 0x62,
...
var file_question_proto_goTypes = []interface{}{
	(*PaginateRequest)(nil), // 0: PaginateRequest
	(*IndexResponse)(nil),   // 1: IndexResponse
}
var file_question_proto_depIdxs = []int32{
	0, // 0: Question.Index:input_type -> PaginateRequest
	1, // 1: Question.Index:output_type -> IndexResponse
...
type QuestionClient interface {
	Index(ctx context.Context, in *PaginateRequest, opts ...grpc.CallOption) (*IndexResponse, error)
}
...
func (c *questionClient) Index(ctx context.Context, in *PaginateRequest, opts ...grpc.CallOption) (*IndexResponse, error) {
	out := new(IndexResponse)
	err := c.cc.Invoke(ctx, "/Question/Index", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type QuestionServer interface {
	Index(context.Context, *PaginateRequest) (*IndexResponse, error)
}
...
func (*UnimplementedQuestionServer) Index(context.Context, *PaginateRequest) (*IndexResponse, error) {
...
func _Question_Index_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(PaginateRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(QuestionServer).Index(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/Question/Index",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(QuestionServer).Index(ctx, req.(*PaginateRequest))
	}
...
var _Question_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "Index",
			Handler:    _Question_Index_Handler,
		},
	},
